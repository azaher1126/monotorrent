...
namespace MonoTorrent.Connections.Peer.Utp
{
    ...
    public sealed class UtpConnection
    {
        ...
        internal UtpConnection(UtpSocketManager manager, IPEndPoint remoteEndPoint,
                               ushort recvId, ushort sendId, bool isIncoming, int targetDelayMs)
        {
            ...
            _targetDelayMs = Math.Max(1, targetDelayMs);
            ...
            InitMtu(1500); // default; manager can update with interface MTU for better seeding
        }
